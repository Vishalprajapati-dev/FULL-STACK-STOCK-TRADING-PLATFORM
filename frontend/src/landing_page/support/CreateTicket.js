        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                 ...
                 <div className='col-4 p-5 mt-2 mb-2'>
                   ...
                   <div className='col-4 p-5 mt-2 mb-2'>
                    <h5 className=''><i class="fa fa-credit-card-alt" aria-hidden="true"></i>Funds</h5>
                   ...
                   <div className='col-4 p-5 mt-2 mb-2'>
                    <h5 className=''><i class="fa fa-circle-o-notch" aria-hidden="true"></i>Console</h5>
                    ...
                    <a href="#"  style={{textDecoration:"none" , lineHeight:"2.5"}}>Refferal Program</a><br/>
                 </div>

                   <div className='col-4 p-5 mt-2 mb-2'>
                    <h5 className=''><i class="fa fa-circle-thin" aria-hidden="true"></i>Coin</h5>
